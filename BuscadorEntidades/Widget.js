  ...
  function (
    ...
    return declare([BaseWidget], {
      ...
      cargaPlanes: function () {
        ...
        // const queryTask = new QueryTask("https://services5.arcgis.com/zZdalPw2d0tQx8G1/arcgis/rest/services/Datos_PlanApp/FeatureServer");

        // const query1 = new Query();
        // query1.returnGeometry = false;

        // query1.outFields = ["subtipo", "codplan ","plan_", "codsubcategoria"];

        // query1.where = `codplan=${this.selectPlan.value}`;

        // console.log("querycon", query1);
        ...
        //   this.listasubPlanes.add(opt);

        //   for (var i = 0; i < results.features.length; i++) {
        //     opt = document.createElement("option");
        //     opt.value = results.features[i].attributes.codsubcategoria;
        //     opt.innerHTML = results.features[i].attributes.subtipo;
      ...
      cargaSubcategorias: function () { console.log("al menos esto va bien") },

      cargaPuntosPlanes: function () { console.log("al menos esto va bien") },

      zoomPlanes: function () { console.log("al menos esto va bien") },
